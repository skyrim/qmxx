...
{
	new buffer[32];
	formatex( buffer, charsmax(buffer), "QKZ %L", id, "QKZ_WELCOME" );
	new menu = menu_create( buffer, "menu_Welcome_handler" );
	
	formatex( buffer, charsmax(buffer), "%L", id, "QKZ_ENTER_GAME" );
	menu_additem( menu, buffer );
	
	formatex( buffer, charsmax(buffer), "%L", id, "QKZ_SPECTATE" );
	menu_additem( menu, buffer );
...
{
	new buffer[32];
	formatex( buffer, charsmax(buffer), "QKZ %L", id, "QKZ_MENU" );
	new menu = menu_create( buffer, "menu_KZMenu_handler" );

	formatex( buffer, charsmax(buffer), "Checkpoint - #%d", g_player_CPcounter[id] );
	menu_additem( menu, buffer );
	formatex( buffer, charsmax(buffer), "Teleport - #%d", g_player_TPcounter[id] );
	menu_additem( menu, buffer );
	menu_additem( menu, "Stuck" );
	menu_additem( menu, "Start" );
	menu_additem( menu, "Pause" );
	menu_additem( menu, "Stop" );
